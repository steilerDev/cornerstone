...
/**
 * Exports diary entries as a PDF.
 */
export async function exportDiaryPdf(params?: {
  dateFrom?: string;
  dateTo?: string;
  types?: string;
  ...
  if (params?.includeAutomatic !== undefined) {
    queryParams.set('includeAutomatic', params.includeAutomatic.toString());
  }
  if (params?.includePhotos !== undefined) {
    queryParams.set('includePhotos', params.includePhotos.toString());
  }
