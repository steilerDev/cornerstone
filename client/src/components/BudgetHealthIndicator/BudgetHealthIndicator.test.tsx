...
describe('BudgetHealthIndicator', () => {
  ...
  it('shows "On Budget" when margin > 10%', () => {
    ...
    render(
      <BudgetHealthIndicator remainingVsProjectedMax={15000} availableFunds={100000} />,
    );
  ...
  it('shows "On Budget" when margin is exactly above 10%', () => {
    ...
    render(
      <BudgetHealthIndicator remainingVsProjectedMax={11000} availableFunds={100000} />,
    );
  ...
  it('applies onBudget CSS class when margin > 10%', () => {
    render(
      <BudgetHealthIndicator remainingVsProjectedMax={50000} availableFunds={100000} />,
    );
  ...
  it('shows "At Risk" when margin is between 0% and 10%', () => {
    ...
    render(
      <BudgetHealthIndicator remainingVsProjectedMax={5000} availableFunds={100000} />,
    );
  ...
  it('shows "At Risk" when remaining is 0 but not negative (availableFunds > 0)', () => {
    ...
    render(
      <BudgetHealthIndicator remainingVsProjectedMax={0} availableFunds={100000} />,
    );
  ...
  it('shows "At Risk" when availableFunds is 0 (special case)', () => {
    ...
    render(
      <BudgetHealthIndicator remainingVsProjectedMax={0} availableFunds={0} />,
    );
  ...
  it('applies atRisk CSS class when margin <= 10%', () => {
    render(
      <BudgetHealthIndicator remainingVsProjectedMax={9000} availableFunds={100000} />,
    );
  ...
  it('shows "Over Budget" when remaining is negative', () => {
    render(
      <BudgetHealthIndicator remainingVsProjectedMax={-1} availableFunds={100000} />,
    );
  ...
  it('shows "Over Budget" when remaining is negative even with availableFunds = 0', () => {
    render(
      <BudgetHealthIndicator remainingVsProjectedMax={-100} availableFunds={0} />,
    );
  ...
  it('shows "On Budget" with very large funds and large positive remaining', () => {
    ...
    render(
      <BudgetHealthIndicator remainingVsProjectedMax={1000000} availableFunds={5000000} />,
    );
