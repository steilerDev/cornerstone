...
jest.unstable_mockModule('./DiaryPage.module.css', () => ({
  default: new Proxy(
    {},
...
jest.unstable_mockModule('../../components/diary/DiaryFilterBar/DiaryFilterBar.module.css', () => ({
  default: new Proxy(
    {},
    { get: (_t, prop) => (typeof prop === 'string' ? prop : '') },
  ),
...
jest.unstable_mockModule('../../components/diary/DiaryEntryTypeSwitcher/DiaryEntryTypeSwitcher.module.css', () => ({
  default: new Proxy(
    {},
    { get: (_t, prop) => (typeof prop === 'string' ? prop : '') },
  ),
...
jest.unstable_mockModule('../../components/diary/DiaryDateGroup/DiaryDateGroup.module.css', () => ({
  default: new Proxy(
    {},
    { get: (_t, prop) => (typeof prop === 'string' ? prop : '') },
  ),
...
jest.unstable_mockModule('../../components/diary/DiaryEntryCard/DiaryEntryCard.module.css', () => ({
  default: new Proxy(
    {},
    { get: (_t, prop) => (typeof prop === 'string' ? prop : '') },
  ),
