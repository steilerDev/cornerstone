...
beforeEach(async () => {
  ...
  mockFetchBudgetCategories.mockResolvedValue({
    categories: [
      { id: 'bc-construction', name: 'Construction', color: '#ff0000', sortOrder: 1 },
      { id: 'bc-materials', name: 'Materials', color: '#00ff00', sortOrder: 2 },
    ],
  });
  mockFetchBudgetSources.mockResolvedValue({
    budgetSources: [
      { id: 'bs-disc', name: 'Discretionary', isDiscretionary: true, status: 'active' },
      { id: 'bs-loan', name: 'Bank Loan', isDiscretionary: false, status: 'active' },
    ],
  });
