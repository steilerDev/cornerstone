...
describe('Vendor interface', () => {
  ...
  it('TradeSummary color can be null', () => {
    const vendor: Vendor = {
      ...
      trade: { id: 'trade-custom', name: 'Custom Trade', color: null },
      phone: null,
      email: null,
      address: null,
      notes: null,
...
describe('VendorDetail interface', () => {
  it('extends Vendor with invoiceCount, outstandingBalance, and contacts', () => {
    const detail: VendorDetail = {
      id: 'v-detail-1',
      name: 'Master Builder',
      trade: { id: 'trade-general-contractor', name: 'General Contractor', color: '#6366F1' },
      phone: '+49-555-1234',
  ...
  it('wraps a Vendor in the vendor field', () => {
    const response: VendorCreateResponse = {
      vendor: {
        ...
        trade: { id: 'trade-flooring', name: 'Flooring', color: '#D97706' },
        phone: null,
        email: null,
        address: null,
        notes: null,
