# Cornerstone Individual Contributor License Agreement

Based on the [Harmony Individual Contributor License Agreement (HA-CLA-I) v1.0](https://www.harmonyagreements.org/), licensed under [Creative Commons Attribution 3.0 Unported License](https://creativecommons.org/licenses/by/3.0/).

---

Thank you for your interest in contributing to **Cornerstone** ("We" or "Us").

This contributor agreement ("Agreement") documents the rights granted by contributors to Us. To make this document effective, please follow the instructions provided by the CLA Assistant when submitting your first pull request. This is a legally binding document, so please read it carefully before agreeing to it. The Agreement may cover more than one software project managed by Us.
...
**Us:** Frank Steiler (Cornerstone Project)
