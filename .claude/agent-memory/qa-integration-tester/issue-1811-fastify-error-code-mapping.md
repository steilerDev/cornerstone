...
**Test pattern for FST\_\* mapping** (`server/src/plugins/errorHandler.test.ts`, new describe
...
pre-existing `AppError` handling block) is _not_ part of this issue's new code (the
