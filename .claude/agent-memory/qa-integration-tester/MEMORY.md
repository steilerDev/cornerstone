...
- [Story #1965 — report legend reinstatement](story-1965-report-legend.md) (2026-08-03) — footnotes[] reinstated for split/depositReduced; locale-aware positive-check pattern (use expected.depositFootnoteText not hardcoded English inside en/de loop); goneFootnotes extension technique.
