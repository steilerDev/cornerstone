...
- [Story #1877 — contact fields, household settings, attachment typing](story-1877-contact-fields-attachment-typing.md) (2026-07-29) — coverage-tooling artifact on `if (!request.user) throw` guards; ripple files findable only via `tsc --noEmit`; new app_settings key-value table pattern.
