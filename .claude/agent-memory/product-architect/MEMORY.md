...
- **`.claude/agent-memory/` exists in BOTH the base checkout and every worktree, at diverging lengths.**
  An "absolute" path that omits the `.claude/worktrees/<name>/` segment silently reads/edits the *base*
