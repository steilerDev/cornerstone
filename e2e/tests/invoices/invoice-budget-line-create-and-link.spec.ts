...
test.describe('Create and link budget line — unit pricing (Scenario 1)', () => {
  test('Work item budget line created with unit pricing appears in invoice table with correct amounts', async ({
    page,
    testPrefix,
  }) => {
...
test.describe('Create and link budget line — from non-empty list (Scenario 2)', () => {
  test('Create Budget Line button appears below existing lines; direct amount creates and links', async ({
    page,
    testPrefix,
  }) => {
    const detailPage = new InvoiceDetailPage(page);
...
test.describe('Create and link budget line — link error (Scenario 3)', () => {
  test('When new line amount exceeds invoice total, form closes and error banner shown in list view', async ({
    page,
    testPrefix,
  }) => {
    const detailPage = new InvoiceDetailPage(page);
...
test.describe('Create and link budget line — mobile responsive (Scenario 4)', () => {
  test('Budget line create form is usable on a mobile viewport', async ({ page, testPrefix }) => {
...
test.describe('Budget line picker — Escape key closes modal (Scenario 5)', () => {
  test('Pressing Escape while on the create form dismisses the picker modal entirely', async ({
    page,
    testPrefix,
  }) => {
    const detailPage = new InvoiceDetailPage(page);
